...
slack = Slacker('xoxb-1550934577952-1527246562034-zU9UVbkjV15KZQVF5hsWcFkO')
slack.chat.post_message('#info', 'Hello shkim?')
...
slack.chat.post_message(channel="#info", text=markdown_text, attachments=attach_list)
